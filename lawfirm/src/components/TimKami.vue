<template>
    <div class="section-1">
        <h2 class="md:text-2xl font-semibold mt-5 md:ml-28 ml-4">Tim Kami</h2>
        <p class="md:text-4xl font-semibold mt-4 ml-4 mb-5 md:ml-28">INOVASI DAN KOLABORASI DALAM PERSPEKTIF HUKUM
        </p>
        ...
        <div class="md:text-xl md:mt-20 p-4 md:ml-28 md:mr-10 md:flex md:justify-start md:items-start">
            <div class="md:text-xl md:mr-10">
                ...
                <p>Menegakkan Hukum seadil-adilnya serta dapat memberikan keadilan bagi Seluruh Rakyat Indonesia</p>
            </div>
    ...
    <div class="section-profile ">
        ...
        <p class="ml-4 mt-4 md:text-xl md:ml-28">Tim kami terdiri dari advokat berpengalaman dan ahli yang terus
            mengembangkan <br>
        ...
        <div class="flex justify-around md:mt-10">
            ...
            <div class="flex w-full flex-col justify-center items-center pb-10">
                ...
                <p class="md:text-xl text-center">Muchamad Ilham Tantowi. S.H., M.H</p>
                <router-link to="tim1">
                    <div
