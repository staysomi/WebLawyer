...
<template>
    ...
    <div>
        ...
        <div class="text-sm mt-20 flex flex-col md:flex-row">
            <!-- Konten 1 -->
            <div class="md:text-xl p-4 md:ml-28 ">
            ...
            <!-- Konten 2 -->
            <div class="md:text-xl p-4 block md:mr-28 md:ml-10">
        Lorem ipsum dolor sit amet, adipiscing elit.
        <p>Nullam fringilla nec nisl id vehicula. Curabitur leo ante,</p>
        <p>ornare ac urna sodales, volutpat egestas ante.</p>
        <p>Praesent volutpat turpis nibh, vitae posuere erat elementum.</p>
        <div @click="showPopup = true"
            class="cursor-pointer bg-blue-900 w-40 py-1 rounded-full hover:bg-blue-300 border-2 border-white text-center text-white md:text-sm mt-4">
            LIHAT LEGALITAS
        </div>
     </div>
    </div>
    ...
    <Popup :isVisible="showPopup" @close="showPopup = false">
        ...
        <p class="text-medium mb-4 text-white">Akta notaris<br>
